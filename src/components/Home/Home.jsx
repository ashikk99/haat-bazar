...
const Home = () => {
    return (
        <div>
            ...
            {/* <Products></Products> */}
            <div className='grid grid-cols-1  md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 w-5/6 mx-auto '>
                <Card></Card>
                <Card></Card>
                <Card></Card>
                <Card></Card>
            ...
            <div className='grid grid-cols-1  md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 w-5/6 mx-auto my-10  '>
                <Card></Card>
                <Card></Card>
                <Card></Card>
                <Card></Card>
